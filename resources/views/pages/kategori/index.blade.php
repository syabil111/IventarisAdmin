...
<div class="container-fluid py-4 px-4 main-wrapper" style="background: #f9f3ef; min-height: 100vh;">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-center">
                        <div class="hero-icon rounded-3 p-4 d-inline-block">
                            <i class="bi bi-tags-fill display-4 text-white"></i>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 animate-header">
        ...
        <a href="{{ route('kategori.create') }}" class="btn btn-add-category d-flex align-items-center gap-2 shadow-lg">
                    ...
                    <tbody>
                        @foreach ($kategoris as $kategori)
                            <tr class="table-row animate__animated animate__fadeInUp" data-id="{{ $kategori->id }}">
                                ...
                                <td class="fw-semibold" style="color: #1b3c53;">{{ strtoupper($kategori->nama_kategori) }}</td>
                                ...
                                <td class="text-center">
                                    <span class="badge px-3 py-2 rounded-pill shadow-sm {{ $kategori->status ? 'bg-success-soft' : 'bg-danger-soft' }}" 
                                          style="{{ $kategori->status ? 'background: rgba(69, 104, 130, 0.1)!important; color: #456882;' : 'background: rgba(27, 60, 83, 0.1)!important; color: #1b3c53;' }}">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form action="{{ route('kategori.destroy', $kategori->id) }}" method="POST" class="delete-form d-inline">
                                            @csrf
                                            @method('DELETE')
